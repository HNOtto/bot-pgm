module.exports = {
	...
	Firmness: {	
		...
		aliases: [],
		desc:
		"Become immune to special effects (still vulnerable to CC)",
	...
	Group Assassination: {	
		...
		aliases: [],
		desc:
		"Deals damage to all enemies /n HP recovery if cast cancelled",
	...
	Protection: {	
		...
		aliases: [],
		desc:
		"Decrease weakest ally DMG taken",
